...
- January 24, 2025. Implémentation sélection dates personnalisées génération calendrier éditorial : remplacement système périodes prédéfinies par sélecteurs date début/fin avec validation intelligente, dates par défaut (aujourd'hui à +1 mois), validation côté backend durée et cohérence dates, transmission format JSON period.startDate/endDate au webhook n8n, interface utilisateur modernisée avec aperçu dynamique de la période calculée
