...
- January 24, 2025. Ajout sélection période génération calendrier éditorial : nouveau champ de sélection période avec option mensuelle par défaut (recommandée), sélecteur période personnalisée (1 semaine à 6 mois) qui s'affiche quand mensuel est décoché, transmission paramètre period au webhook n8n, création composant Checkbox UI manquant, amélioration interface utilisateur avec aperçu dynamique de la période sélectionnée
